...
(function(window, document, undefined) {
    ...
    if (type == 'SVG') {
        ...
        slide = $('svg', { id: 'svg2', xmlns: 'http://www.w3.org/2000/svg', version: '1.1', width: '100%', height: '100%' },
                  [
                      $('defs', {},
        ...
        picker = $('svg', { id: 'svg1', xmlns: 'http://www.w3.org/2000/svg', version: '1.1', width: '100%', height: '100%' },
                   [
                       $('defs', {},
                         [
...
ColorPicker(
        ...
        function(hex, hsv, rgb) {
          ...
          document.getElementById('col1').style.color = hex;
        });