...
mp.game.graphics.notify('~r~NoClip nur für Entwickler');
...
mp.keys.bind(bindVirtualKeys.F12, true, function() {
...
function startNoClip() {
  ...
  mp.game.graphics.notify('NoClip ~g~Aktiviert');
...
function stopNoClip() {
  ...
  mp.game.graphics.notify('NoClip ~r~Deaktiviert');
